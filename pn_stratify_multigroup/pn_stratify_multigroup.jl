...
# ╔═╡ dc64ace5-c65c-40e3-a5b9-41649681c9b8
begin
...
# ╔═╡ 54eabc3a-dff5-4c5f-a62e-f71885ba38a7
md"""
...
# ╔═╡ 17a049b4-e3e3-4080-aaed-d039e3f9e4ce
md"""
## Transitions
...
# ╔═╡ 388055ba-c8c4-4271-bc0e-b24af7a69205
...
# ╔═╡ 8e98c4cd-3b4c-4922-81e8-7095a7e5c166
Graph(epi_transitions)

# ╔═╡ 40294ec1-c1aa-4e12-b416-28754fb50c9a
md"""
...
# ╔═╡ 5dc6d30d-b113-434a-8450-9ba1015d3bae
sir_uwd = @relation () where (S::Pop, I::Pop, R::Pop) begin
    infection(S, I, I, I)
    recovery(I, R)
end;

# ╔═╡ 21c351ba-3afb-4ad3-9cfe-8f194a85dbc6
sir_acst = oapply_typed(epi_transitions, sir_uwd, [:β , :γ]);

# ╔═╡ 0ef5a81a-d1a6-491b-9f40-2639e5ea35a3
sir_lpn = dom(sir_acst);

# ╔═╡ 46e638f1-7dba-4200-b253-e7233ddc7442
Graph(sir_lpn)

# ╔═╡ bd1ee042-d537-4b57-a227-1389a092b06c
md"""
...
# ╔═╡ 107b3dd2-7c28-45d3-af5c-66590590f566
...
# ╔═╡ 12df6217-c577-484c-96d1-47171fd73f6d
risk_acst = oapply_typed(epi_transitions, risk_uwd, [:HH, :HL, :LH, :LL, :H, :L]);

# ╔═╡ b9be60e0-6153-415d-968c-e67dbf5e821d
risk_lpn = dom(risk_acst);

# ╔═╡ 056bb2dc-eb96-4b11-a7ec-c5a780f051e2
Graph(risk_lpn)

# ╔═╡ 8455c513-62b8-41f8-8c41-9b93253cb40f
md"""
...
# ╔═╡ 28a41c72-dfbc-489c-bc04-318a36310d95
sir_risk_acst = typed_product(sir_acst, risk_acst);

# ╔═╡ 4a2851ce-0cc7-4ca5-8053-3409ea1c8a02
sir_risk_lpn = dom(sir_risk_acst);

# ╔═╡ 3eb64f13-27b4-46cc-827b-55f26adc796d
Graph(sir_risk_lpn)

# ╔═╡ 4d71efa3-9284-4d14-887a-30af80d01d86
md"""
The state names of the resulting stratified model are tuples of symbols:
"""

# ╔═╡ 4ad10dc1-97bb-4a10-9ee6-14fb46bdb2c5
snames(sir_risk_lpn)

# ╔═╡ fb993860-0772-4091-a983-d80a2e7f2310
md"""
...
# ╔═╡ c69d88c9-bd6e-4bad-8406-56cef2bdaacb
sir_risk_lpn_flatlabels = flatten_labels(sir_risk_lpn);

# ╔═╡ 7c31ace3-145f-4251-b92a-09a15e4adb98
Graph(sir_risk_lpn_flatlabels)

# ╔═╡ 7f49a7f9-e385-453c-90f0-1956e8e22203
md"""
## Running the model
...
# ╔═╡ c202b599-f29d-4ea6-adbf-36c86aa58b9f
begin
	K = 2
	S = [495.0, 495.0]
	I = [5.0, 5.0]
...
# ╔═╡ c2ba6482-c2ea-4854-bbe1-2e41ed925d00
md"""
...
# ╔═╡ 01c56a9c-368c-4950-8545-55369eca2d1c
begin
	β = 0.05
	c = [20.0, 5.0]
...
# ╔═╡ f820bae2-01fd-4382-84b6-d01cc8bca205
md"""
We now define the initial conditions and parameter arrays as labelled
arrays.
"""

# ╔═╡ 4d668c42-58b6-48b5-a227-60c96e0743c4
begin
...
[compat]
AlgebraicDynamics = "~0.1.8"
AlgebraicPetri = "~0.8.11"
Catlab = "~0.14.17"
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "373ed01345f29bd05baec6f4b7683feec6a6997c"
...
deps = ["Catlab", "Compose", "DelayDiffEq", "DifferentialEquations", "LabelledArrays", "LinearAlgebra", "LinearMaps", "OrdinaryDiffEq", "Plots", "RecipesBase", "RecursiveArrayTools", "Requires", "StaticArrays"]
git-tree-sha1 = "749a52eb8b64b0280e245351ebfbd9e043f4884f"
uuid = "5fd6ff03-a254-427e-8840-ba658f502e32"
version = "0.1.8"

[[deps.AlgebraicPetri]]
deps = ["Catlab", "DataStructures", "GeneralizedGenerated", "LabelledArrays", "StatsBase"]
git-tree-sha1 = "3607af61f8ab68825b3ad37cdd166b756fb688ef"
...
git-tree-sha1 = "821d6dcf331981e7c1d6377a6baee112a79a1021"
...
git-tree-sha1 = "d4514497594519b3c20e93a609389fddb4ee39ab"
...
git-tree-sha1 = "67a072ae51be0ae71a9173f15ee7593c398b43b8"

...
# ╔═╡ 5903dbc7-a7d1-4f12-9f40-82aa5fe23230
begin
...
# ╔═╡ cdf71ea3-7d70-45ce-ac77-9b89b26e769f
md"""
...
# ╔═╡ 075bec78-5745-41c3-b426-1a8cc069fb2c
md"""
## Transitions
...
# ╔═╡ bcd036e8-5a3a-4d9d-a18f-1b313a5f2149
begin
	nstages = 4
...
# ╔═╡ 45f1b6b6-820e-4510-9b8a-b39bf5506d2d
md"""
...
# ╔═╡ 5dfa4df4-eae1-49c0-a333-07c5cd1bde57
...
# ╔═╡ 8aeb5852-f365-450f-a517-3b2318d08503
md"""
...
# ╔═╡ 7e0ca730-3dc3-448e-ae7c-cd24d8c7c4f4
...
# ╔═╡ b8b76301-a85b-4e68-b572-875ff3e057e3
betas = Symbol.([sub("β",i) for i=1:nstages]);

# ╔═╡ 39f61a78-f63d-4c54-aec8-01e7fd2201d3
si_acst = oapply_typed(epi_lpn, si_uwd, betas);

# ╔═╡ d4ac8026-a662-44f8-ba8d-68a50b031c44
si_lpn = dom(si_acst);

# ╔═╡ 417ae9dd-dd41-4fa6-b3de-f320277dcb5c
Graph(si_lpn)

# ╔═╡ 1b6be107-5bd9-434f-be4c-473b1113e74e
md"""
...
# ╔═╡ 07c7d701-a37a-45c7-ad46-fa4a5010bfaf
...
# ╔═╡ 95d34f5e-34fe-41c9-a850-e29a1859a883
deltas = Symbol.([sub("δ",i) for i=1:nstages]);

# ╔═╡ 463ece40-ebe8-4d55-9053-6e78bdaa35b6
ir_acst = oapply_typed(epi_lpn, ir_uwd, deltas);

# ╔═╡ 106c9735-eff6-49b6-b3f9-ec60a6087320
ir_lpn = dom(ir_acst);

# ╔═╡ 528b069d-31bb-4b3c-a0cc-287ebafbe005
Graph(ir_lpn)

# ╔═╡ 31e49069-0ea4-4dec-bdcc-52dc2054935c
md"""
...
# ╔═╡ 32baa507-6689-4ffa-9048-bdd55587d8fa
sir_uwd = @relation (S, I₁, I₂, I₃, I₄, R) where (S::Pop, I₁::Pop, I₂::Pop, I₃::Pop, I₄::Pop, R::Pop) begin
    si(S, I₁, I₂, I₃, I₄)
    ir(I₁, I₂, I₃, I₄, R)
end;

# ╔═╡ 8688302e-3d33-436b-9cc1-798bca67c5a8
sir_smc = oapply(sir_uwd, Dict(
    :si => Open(si_lpn),
    :ir => Open(ir_lpn),
));

# ╔═╡ edcec8e6-7bf2-42b3-8038-1edb844ec8c2
sir_lpn = apex(sir_smc);

# ╔═╡ 087e053d-51b8-4726-90ad-2dcbb0c00453
Graph(sir_lpn)

# ╔═╡ 72d08fb1-e09e-443a-8829-16e8303ab65d
md"""
## Running the model
...
# ╔═╡ ebd8124f-6b1b-4425-a04f-b0b9601921e4
sir_vf = vectorfield(sir_lpn);

# ╔═╡ 40d820ff-0d67-4243-8d7f-549b952ffbe3
u0 = @LArray [990.0, 10.0, 0.0, 0.0, 0.0, 0.0] Tuple(snames(sir_lpn));

# ╔═╡ 1f7874b3-23bb-4776-80a7-1d82af3b75cd
p = @LArray vec([repeat([0.5/1000],4); repeat([0.25/4],4)]) Tuple(tnames(sir_lpn));

# ╔═╡ 936271de-39fb-4a53-ba8a-936e63afd76c
tspan = (0.0, 40.0);

# ╔═╡ 54d0af4a-fb1b-4985-aa86-917c9f92e9af
md"""
We can now solve the system.
"""

# ╔═╡ 497e7176-482e-49d7-8224-0656309c12be
sir_prob = ODEProblem(sir_vf, u0, tspan, p);

# ╔═╡ fcaa8e9f-da0e-4ba9-83bb-802c4765ca89
sir_sol = solve(sir_prob, Rosenbrock32());

# ╔═╡ d7c53ee1-8b45-4ad3-955e-50dae369a18b
plot(sir_sol)

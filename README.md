...
- [Adding vaccination to an existing SIR model](https://github.com/epirecipes/EpiCats/blob/main/pn_compose_sirv/pn_compose_sirv.md)
...
- [SEIR model stratified by age, replicating `model_default` from the R `epidemics` package](https://github.com/epirecipes/EpiCats/blob/main/pn_stratify_ageclasses/pn_stratify_ageclasses.md)

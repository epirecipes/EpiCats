...
# ╔═╡ beb39c0d-5be7-44ca-8e3a-fa4b6c403e1d
begin
...
# ╔═╡ 89bb2a8d-0fc4-44a8-9e9d-fe19722129e6
md"""
# Composing an SIR model from individual transitions using AlgebraicPetri.jl
...
# ╔═╡ 0b39c32c-d1b8-490c-91b5-e5401371cc11
md"""
## Transitions
...
# ╔═╡ 4a4b71ef-04f5-4648-a1ca-43d6e96a77c1
...
# ╔═╡ 2c84aae6-c813-4bc9-b9a1-c643711892bd
md"""
...
# ╔═╡ a6eda3f8-920d-4483-837a-c22f7970603f
si_uwd = @relation (S, I) where (S::Pop, I::Pop) begin
    infection(S, I, I, I)
end;

# ╔═╡ 649a2bc2-8164-41a1-80f0-c1a822d36971
md"""
...
# ╔═╡ 7708ea94-b598-44dd-92c9-ef3a5c3e9383
si_acst = oapply_typed(epi_lpn, si_uwd, [:β]);

# ╔═╡ c0e63e88-82e2-4d62-8cdd-43d1eab3ba9a
md"""
To obtain the labelled Petri net, we extract the domain of the
`ACSetTransformation` using `dom`.
"""

# ╔═╡ 7ca32c01-df1a-44b0-8504-eae3029ea9bb
si_lpn = dom(si_acst);

# ╔═╡ e94eae9d-791c-4abc-895b-9427a76e4582
md"""
We can obtain a GraphViz representation of the labelled Petri net using
`Graph`.
"""

# ╔═╡ 7c40888d-122a-49d0-9db8-5bd283948402
Graph(si_lpn)

# ╔═╡ 174460ea-4007-400e-9e77-2715f85b74a4
md"""
We repeat for the recovery (`I` to `R`) transition.
"""

# ╔═╡ e52f5229-d2c9-4b8b-8e06-7e878f0e650f
begin
...
# ╔═╡ 51115c7e-bfec-4d8d-9059-2b9c022dccec
md"""
...
# ╔═╡ 9580c3e9-8805-49dd-b0d2-73def266a1e1
sir_uwd = @relation (S, I, R) where (S::Pop, I::Pop, R::Pop) begin
    si(S, I)
    ir(I, R)
end;

# ╔═╡ ffc971e0-f186-46b7-bdd8-cd1e671e175e
md"""
...
# ╔═╡ d95fd927-cff5-4a96-a0a0-86410263d382
sir_smc = oapply(sir_uwd, Dict(
    :si => Open(si_lpn),
    :ir => Open(ir_lpn),
));

# ╔═╡ 88a5efcd-dc56-496b-8290-42e96bf91339
md"""
We extract the labelled Petri net by extracting the object that is the
codomain of all the legs, using the `apex` function.
"""

# ╔═╡ 0d4d02c2-2748-4558-9035-0397288d91f8
sir_lpn = apex(sir_smc);

# ╔═╡ 7565511a-bb33-4fc3-8fc6-7ae32d3bf130
Graph(sir_lpn)

# ╔═╡ 74f1aad3-603a-4e4f-aeb1-49af8f96cfe8
md"""
## Running the model
